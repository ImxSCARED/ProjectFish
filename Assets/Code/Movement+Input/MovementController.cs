...
public class MovementController : MonoBehaviour
{
    ...
    public void MoveWithCollision(Vector3 movement)
    {
        ...
        RaycastHit hitInfo;
        if (Physics.BoxCast(m_collider.transform.position, m_collider.bounds.extents, movement.normalized, out hitInfo, m_collider.transform.rotation, movement.magnitude))
        {
